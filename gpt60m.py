"""
GPT 60M model — exact architecture from Low-rank-Muon/train_gpt_tiny.py.

8 layers, 8 heads, 512 dim, FlexAttention, RoPE, value embeddings,
skip connections, ReLU² MLP, soft-capped logits.
"""
